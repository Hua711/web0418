...
這是一個基於 HTML Canvas 實現的波浪線動畫專案，建立於 2025/04/18。

## 專案說明
這個專案實現了一個簡單優雅的波浪線動畫。波浪線會隨機生成，並自然地從右向左流動，呈現出平滑、連續的波動效果。
...
### 使用方法
直接在瀏覽器中打開 index.html 文件即可查看動畫效果。
